...
-   Analyze task complexity with `analyze_complexity` / `task-master analyze-complexity --research_files` (see [`taskmaster.md`](mdc:.roo/rules/taskmaster.md)) before breaking down tasks
...
-   Run `analyze_complexity` / `task-master analyze-complexity --research_files` (see [`taskmaster.md`](mdc:.roo/rules/taskmaster.md)) for comprehensive analysis
...
-   Add `--research_files` flag to leverage Perplexity AI for research_files-backed expansion
